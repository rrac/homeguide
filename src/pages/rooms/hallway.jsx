      ...
      <Container>
        <Row>
          <Col xs="5" sm="5">
            ...
            <Image src="/assets/hallway3.png" thumbnail />{" "}
          </Col>
          <Col xs="7" sm="7">
            <p>
              ...
              turn off around midnight. There are two sets of louvre doors in
              the hallway on the right as you walk to the back. Behind the first
              set, we store all the cleaning materials and a few hand and larger
              vacuum cleaners, mostly used by the housekeeping ladies. Behind
              the second set of louvre doors are the washer and dryer. The
              shelfs around the walls in this closet contain numerous baskets
              with extra sets of sheets, household items, a collection of
              different sizes of common alkaline batteries for devices used
