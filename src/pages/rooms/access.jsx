		...
		return (
			<Grid>
				<Row>
					...
					<Col xs="7" sm="7">
						<p>As you open the gate, walk down the path to the right of the staircase to reach the front door.</p>
					</Col>
				</Row>
				<Row>
					<Col xs="5" sm="5">
					...
					<Col xs="7" sm="7">
						<p>
							The front door is a "Dutch" type door. From the inside, you will see that you can open the top part
							separately from the bottom. Because the door is always in the shade, when the top part is open together
							with other windows or the front French door, cool air can circulate easier.
						</p>
					</Col>
				</Row>
				<Row>
					...
					<Col xs="7" sm="7">
						<p>
							As you approach the front door, you will notice that there is a black/shiny lock that will be completely
