			...
			<Grid>
				<Row>
					...
					<Col xs="7" sm="7">
						...
						<p>
							To maintain my professional contributions, I intend to join the ranks of adjunct counselors/instructors
							and continue my coordinator role with the California Community Colleges’ Success Network (3CSN). Within
							this realm I am especially interested in helping students and fellow faculty embrace Community Based
							Learning.
						</p>
					</Col>
				</Row>
				<Row>
					...
					<Col xs="7" sm="7">
						<h3>Ron Connal</h3>
						<p>
							All things mechanical have always piqued my interest. After a botched attempt at becoming an architect, I
							submerged myself in all matter mechanical and got saddled with a degree in Electro-Mechanical Engineering,
							then furthered that with some Industrial Engineering while working at Ford Tractor in Antwerp, Belgium.
							While dipping my toes in "data processing" at both Ford and Ingersoll Engineers, in Brussels at the time,
							I participated as a consultant engineer in the US, Taiwan, Germany, France, UK and the Netherlands on
							large industrial project for government and non-government entities. A software development side track
							from that period turned into a full fledged passion when moving to the US. Retired for many years, I am
							still at it in order to keep the brain cells going, however my love of cooking now often takes a front row
							seat.
						</p>
					</Col>
				</Row>
